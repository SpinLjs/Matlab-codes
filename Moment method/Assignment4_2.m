...
zitvob=1e-3;
yitvob=1e-3;
z=1e-1:zitvob:3e-1;  % observe points;
y=LS(2);
...
Max_trs(i_t)=max(abs(E_total));
end

plot(f,(Max_trs));
xlabel('Frequency / GHz');
ylabel('Max electrical field in the last-half area of observation points');
